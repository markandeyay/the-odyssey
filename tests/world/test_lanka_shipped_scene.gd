...
const PREFABS: Dictionary = {
	...
	"keffer": "res://scenes/prefabs/gameplay/keffer_interaction.tscn",
...
const EXPECTED: Dictionary = {
	&"shallows": {"campfire": 2, "cairn": 2, "component": 1,
		"district_trigger": 1, "fragment": 4, "keffer": 1, "ocean_kill": 1, "setu": 1},
	...
	&"spine": {"campfire": 1, "component": 1, "dark_entrance": 1, "district_trigger": 1, "fragment": 3},
