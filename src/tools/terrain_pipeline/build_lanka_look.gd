...
func _make_environment() -> Environment:
	...
	sky_material.sky_top_color = Color(0.075, 0.115, 0.11)
	sky_material.sky_horizon_color = Color(0.42, 0.45, 0.40)
	sky_material.ground_bottom_color = Color(0.030, 0.042, 0.040)
	sky_material.ground_horizon_color = Color(0.22, 0.26, 0.235)
